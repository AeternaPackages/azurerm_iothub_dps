...
output "iothub_dps_id" {
  ...
  value       = module.iothub_dps.iothub_dps_id
}
...
output "iothub_dps_allocation_policy" {
  ...
  value       = module.iothub_dps.iothub_dps_allocation_policy
}
...
output "iothub_dps_data_residency_enabled" {
  ...
  value       = module.iothub_dps.iothub_dps_data_residency_enabled
}
...
output "iothub_dps_public_network_access_enabled" {
  ...
  value       = module.iothub_dps.iothub_dps_public_network_access_enabled
}
...
output "iothub_dps_resource_group_name" {
  ...
  value       = module.iothub_dps.iothub_dps_resource_group_name
}
